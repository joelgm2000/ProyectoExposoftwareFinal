...
namespace exposoftwaredotnet.Service
{
    public class JwtService
    {
        ...
        public LoginViewModel GenerateToken(User userLogIn)
        {
            ...
            var userResponse = new LoginViewModel() { UserName = userLogIn.UserName, Email = userLogIn.Email};
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                Subject = new ClaimsIdentity(new Claim[]
                {
                    ...
                    new Claim(ClaimTypes.Role, userLogIn.Rol.ToString()),
                }),
